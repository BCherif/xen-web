...
export class ProjectsComponent implements OnInit
{
    ...
    displayedColumns = ['name','budget','state','program','locality','buttons'];
     ...
     */
    ngOnInit(): void {
        document.title = 'XENSA | Projets';
        this.dataSource = new FilesDataSource(this._projectsService, this.paginator, this.sort);
        ...
        return data.sort((a, b) => {
            ...
            switch ( this._matSort.active )
            {
                ...
                case 'domain':
                    ...
                    break;
                case 'program':
                    [propertyA, propertyB] = [a.program.years, b.program.years];
                    break;
            }
