...
export class RequestsComponent implements OnInit
{
    ...
    displayedColumns = ['requestDate','newSource','elected','category','subject','buttons'];
     ...
     */
    ngOnInit(): void {
        this.dataSource = new FilesDataSource(this._requestsService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._requestsService.requests;
    }
    ...
    connect(): Observable<any[]>
    {
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this._requestsService.requests.slice();
