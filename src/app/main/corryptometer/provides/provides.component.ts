...
import {CS_JUDGMENT, DEGREE, JUDGMENT} from '../../../data/enums/enums';
import {ProvidesService} from './provides.service';

@Component({
    selector     : 'corryptometer-provides',
...
export class ProvidesComponent implements OnInit
{
    ...
    displayedColumns = ['legalFolder', 'jurisdiction','judgment','decisionOfJurisdiction','dateProvide','buttons'];
    ...
    constructor(
        private _providesService: ProvidesService,
     ...
     */
    ngOnInit(): void {
        document.title = 'XENSA | Provides';
        this.dataSource = new FilesDataSource(this._providesService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._providesService.provides;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this._providesService.onProvidesChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this._providesService.provides.slice();
