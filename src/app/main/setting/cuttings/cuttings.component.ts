...
@Component({
    selector     : 'setting-cuttings',
    templateUrl  : './cuttings.component.html',
    styleUrls    : ['./cuttings.component.scss'],
...
export class CuttingsComponent implements OnInit
{
    ...
    newCutting(): void
    {
        this.dialogRef = this._matDialog.open(SettingCuttingFormDialogComponent, {
            panelClass: 'cutting-form-dialog',
            data      : {
                action: 'new'
            }
        });
...
export class FilesDataSource extends DataSource<any>
{
     ...
     * Constructor
     *
     * @param {CuttingsService} _cuttingsService
    ...
    )
    {
        ...
        this.filteredData = this._cuttingsService.cuttings;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this._cuttingsService.onCuttingsChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this._cuttingsService.cuttings.slice();
