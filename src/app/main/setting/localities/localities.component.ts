...
export class LocalitiesComponent implements OnInit
{
    ...
    newLocality(): void {
        this.dialogRef = this._matDialog.open(SettingLocalityFormDialogComponent, {
            panelClass: 'locality-form-dialog',
            data      : {
                action: 'new'
            }
        });
...
export class FilesDataSource extends DataSource<any>
{
     ...
     * Constructor
     *
     * @param {LocalitiesService} _localitiesService
    ...
    )
    {
        ...
        this.filteredData = this._localitiesService.localities;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this._localitiesService.onLocalitiesChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                        let data = this._localitiesService.localities.slice();
        ...
        return data.sort((a, b) => {
            ...
            switch ( this._matSort.active )
            {
                case 'name':
                    ...
                    break;
                case 'cutting':
                    [propertyA, propertyB] = [a.cutting, b.cutting];
                    break;
            }
